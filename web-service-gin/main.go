...
var albums = []album{
	{ID: "1", Title: "Blue Train is ayye", Artist: "John Coltrane", Price: 56.99},
	{ID: "2", Title: "Jeru", Artist: "Gerry Mulligan", Price: 17.99},
	{ID: "3", Title: "Sarah Vaughan and Clifford Brown", Artist: "Sara Vaughan", Price: 39.99},
}
...
func getAlbumByID(c *gin.Context) {
	...
	c.IndentedJSON(http.StatusNotFound, gin.H{"message": "album no found"})
}